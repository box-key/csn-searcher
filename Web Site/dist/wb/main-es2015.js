...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 14, vars: 0, consts: [[1, "container"], ["href", "#", 1, "logo"], ["href", "#", "routerLink", "/"], ["href", "#", "routerLink", "/AboutUs"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        ...
        _aboutus_aboutus_component__WEBPACK_IMPORTED_MODULE_7__["AboutusComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"]] }); })();
...
class HttpService {
    ...
    csn_search(inputText) {
        const API = 'http://35.175.228.225/search?inputText=' + inputText;
        console.log(API);
...
function SearchComponent_ng_template_16_tr_12_Template(rf, ctx) { if (rf & 1) {
...
class SearchComponent {
    ...
    search(inputText) {
        ...
        this._http.csn_search(inputText).subscribe((data) => {
            this.results = data;
...
SearchComponent.ɵfac = function SearchComponent_Factory(t) { return new (t || SearchComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_http_service__WEBPACK_IMPORTED_MODULE_1__["HttpService"])); };
SearchComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SearchComponent, selectors: [["app-search"]], decls: 18, vars: 1, consts: [[1, "container-b"], [1, "group"], ["type", "textarea", "rows", "5", "required", "required"], ["inputText", ""], [1, "highlight"], [1, "bar"], ["hidden", "", 1, "group"], ["type", "text", "required", "required"], [1, "btn-box"], ["type", "submit", 1, "btn", "btn-submit", 3, "click"], [3, "ngIf"], [1, "res"], [4, "ngFor", "ngForOf"], [3, "href"]], template: function SearchComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SearchComponent_Template_button_click_14_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r4); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](3); return ctx.search(_r0.value); });
...
module.exports = __webpack_require__(/*! C:\Users\r\Desktop\csn_search\mywebsite\wb\src\main.ts */"./src/main.ts");
